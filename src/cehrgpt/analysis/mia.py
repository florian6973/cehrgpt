...
train_features = '/data/processed_datasets/processed_datasets/ehr_foundation_data/ohdsi_cumc_deid/ohdsi_cumc_deid_2023q4r3_v3_mapped/models/cehrgpt_flo/features/patient_sequence/cehrgpt_train/features_without_label/train_features'
test_features = '/data/processed_datasets/processed_datasets/ehr_foundation_data/ohdsi_cumc_deid/ohdsi_cumc_deid_2023q4r3_v3_mapped/models/cehrgpt_flo/features/patient_sequence/cehrgpt_test/features_without_label/train_features'
...
def load_features(features_path):
    dfs = []
    for file in glob.glob(os.path.join(features_path, '*.parquet')):
